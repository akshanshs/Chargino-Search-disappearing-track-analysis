...
#	legname = 'distrack'
	...
	pause()
	hratio,hbkg = FabDrawPrediction(c1,legbkg, legsig,hData,dBkgCompositionHist[stackhistsname][0],dSigCompositionHist[stackhistsname],dBkgCompositionHist[stackhistsname][1],var,lumi=35.9,LinearScale=False, fraction = '#frac{data}{prediction}')
#	pause()
