...
fname = '/nfs/dust/cms/user/singha/LLCh/BACKGROUNDII/CMSSW_8_0_20/src/MCTemplatesBinned/BinndTemplatesPt250.root'
fSmear  = TFile(fname)
keys = fSmear.GetListOfKeys()
sfHist  = fSmear.Get('htrkresp')   #htrkrespL

TemplateBinList = [[0,1.4442,0,250],[0,1.4442,250,999999],[1.566,2.4,0,250],[1.566,2.4,250,999999]]
