...
#    hratio.SetFillColor(2)
    ...
    if isdata:
        ...
        variation_up.SetParameters(funcs['f1'+ratname].GetParameter(0) + 2*funcs['f1'+ratname].GetParError(0), funcs['f1'+ratname].GetParameter(1) + 1*funcs['f1'+ratname].GetParError(1), funcs['f1'+ratname].GetParameter(2) + 1*funcs['f1'+ratname].GetParError(2))
        variation_down.SetParameters(funcs['f1'+ratname].GetParameter(0) - 2*funcs['f1'+ratname].GetParError(0), funcs['f1'+ratname].GetParameter(1) - 1*funcs['f1'+ratname].GetParError(1), funcs['f1'+ratname].GetParameter(2) - 1*funcs['f1'+ratname].GetParError(2))
